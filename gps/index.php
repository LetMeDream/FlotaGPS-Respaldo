...
<body>
<header class='d-none d-sm-block' style="text-align: center;background-color:rgb(29, 29, 29)" id='myForm'>
<div>
    <div>
...
<!-- video -->
    <div id='fck' style=' box-sizing: content-box;' class='container-fluid'>
  ...
  <!-- formulario   -->
              <form class="form-wrapper" method='POST' id="form1" >
                <fieldset form="form1" class="section is-active">
                        ...
                        <button disabled='disabled' class="button d-none " id='buttonA' >¡Compare precios!</button>
                    </fieldset>
                    ...
                    <button type='button' id='back2' class='sex'>Volver</button>
    ...
    <!--  Here we can star with the formMerging -->
                ...
                <div class='cuatro'>
                    <input autocomplete='off' class='valid' type='text' name="firstname" placeholdeR='Nombre' id='nombre'>
                    <input autocomplete='off' class='valid' type='text' name="mobile_phone" placeholdeR='Teléfono: 34640000111' id='telefono'>
                    <input autocomplete='off' class='valid'  type='text' name="meta_codigopostal" placeholdeR='Código Postal' id='postalCode'>
                    <input autocomplete='off' class='valid' type='text' name="meta_empresa" placeholdeR='Nombre de Empresa. S.A' id='negocio'>
                    <input autocomplete='off' class='valid' type='text' name="email" placeholdeR='Correo: ejemplo@gmail.com' id='correo'>
                </div>
                    <input type="hidden" name="source" value="<?=isset($_GET['source'])?$_GET['source']:'JHmogps'?>" />
                    <input type="hidden" name="id_country" value="1" />
                    <input type="hidden" name="format" value="json" />
                    <button type='button' id='back2' style='right:200px;' class='sex '>Volver</button>
                    <button class="submit button" form='form1' type="submit" id='buttonA4' value="Submit">¡Compare precios!</button>
                    <!--input class="submit button" form='form1' type="submit" id='buttonA4' value="¡Compare precios!"-->
                    </fieldset>
        ...
        <div class='container-fluid' >
            <div class='wrapper' style='text-align:center'>
                <div class='row sexi' style='display:inline-block; width:100%;'>
                    ...
                    <div class='col col-xl-3 col-lg-3 col-sm-5 toptexts2 col-7' id='toptexts2' style=' color:#ffffff; background-color:rgba(0, 0, 0, 0.70);
                        ...
                        <p class='text-left'>
                          <i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Sistema antirrobo.<br>
                          &nbsp;<i class="fa fa-female" aria-hidden="true"></i>&nbsp; Anti intrusión de polizones<br>
                          ...
                          <i class="fa fa-automobile" aria-hidden="true"></i>&nbsp; Informe de kilometrajes y horas motor.<br>

                          <br>
                          <p><strong>Consigue estos y otros beneficios de sistemas de control de flota, te asesoramos según tus necesidades para que adquieras el mejor servicio y al mejor precio.</strong></p>
                        </p>
                        <div>
                ...
                <div class='row' style='display:inline-block; width: 100%;'>
                    ...
                    <div class='col col-xl-3 col-lg-3 col-sm-5 toptexts col-7 ' id='toptexts' style='background-color:rgba(156, 156, 156, 0.5); border-radius: 1%;box-shadow: 0px 2px 4px rgb(131, 131, 131);'>
                        ...
                        <p class='text-left' >
                            ...
                            <i class="fas fa-gas-pump"></i> Reduce costes de gasolina<br>
                            <i class="fa fa-map" aria-hidden="true"></i> Optimiza las rutas, reduciendo tiempo<br>

<i class="fa fa-wrench" aria-hidden="true"></i> Anticípate a las averías del vehículo antes de que impidan su funcionamiento
                         </p>
                                <a href='#myForm'><button class='buttonInfo'>Solicitar información</button></a>
...
<div  id='footerOfMine'>
  <footer  style=" padding-bottom: 35px;text-align: center;height:110px; background-color:rgb(29, 29, 29)"><p  class='mr-auto lead'>Lead to win</p></footer>
</div>
</body>
</html>
