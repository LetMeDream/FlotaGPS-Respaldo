...
$("#buttonA4").attr('disabled', 'disabled');

  //useless now since you advance by Choosing an option
  ...
  */
  ...
  $('.4 > input').keyup(function(){
    ...
    $('.4 > input').each(function() {
      ...
      if (empty) {
          $('#buttonA4').prop('disabled', true);
      } else {
          $('#buttonA4').prop('disabled', false);
      } 
...
/*
    ...
    */
    ...
    /* Added and trying */
    $(".form-wrapper #back2").click(function(){
        var button = $(this);
        var currentSection = button.parents(".section");
        var currentSectionIndex = currentSection.index();
        var headerSection = $('.steps li').eq(currentSectionIndex);
